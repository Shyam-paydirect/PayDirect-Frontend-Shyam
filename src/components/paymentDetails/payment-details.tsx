...
const PaymentDetails: React.FC = () => {
    ...
    const paymentData = {
        ...
        senderPartyCountryCode: bankDetails.senderPartyCountryCode,
        receivingPartyCountryCode: bankDetails.receivingPartyCountryCode,
        debitAccountForBankCharges: bankDetails.senderAccNo,
