...
import { DollarSign, Clock, Loader, TrendingUp } from "lucide-react";
...
export const SummaryCardsGrid: FC<SummaryCardsGridProps> = ({ balanceData }) => {
  const categories: Category[] = [
    { key: "available", label: "Available", color: "bg-green-500", icon: DollarSign },
    { key: "pending", label: "Pending", color: "bg-orange-500", icon: Clock },
    { key: "processing", label: "Processing", color: "bg-blue-500", icon: Loader },
    { key: "payout_processing", label: "Payout Processing", color: "bg-gray-500", icon: TrendingUp },
    { key: "fee_advance", label: "Fee Advance", color: "bg-purple-500", icon: DollarSign },
  ];
